...
namespace HPeSimpleParser.Test {
    public class ParserTests {
        ...
        public async Task Should_parse_sample(string fileName, int optionCount, int specificationCount, int opcCodes) {
            ...
            var data = await parser.ParseDocument(filePath, VariantType.HPE).ConfigureAwait(false);
            ...
            data.Product.CategoryID.Should().Be("12883|4172267|4172281|4177614|1009689650");
            ...
            data.Options.Items[0].OptionGroupName.Should().NotBeEmpty();
